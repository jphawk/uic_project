...
constructor(props) {
	super(props);
	this.state = {
		name: '', langTo: '', langFrom: '', description: '', fullText: '', errors: []
	};	
...
addNewRequest = (event) => {
	...
	if (this.state.name === '' ){
		this.state.errors.push("Please give a name to your translation request");
	}

	if (document.getElementById("textFile").value === ""){
		this.state.errors.push("Please upload a file with your text to translate");				
	}

	if ( document.getElementById('langTo').value === "" || document.getElementById('langFrom').value === "" ){
		this.state.errors.push("Please select the language to translate from and the language to translate to");		
	}
					...
					<div id="rq-form-wrapper">
						...
						<form accepted-charset="UTF-8" id="rq-form" className="webform-processed">
							...
							<div className="label-input-wrapper">
								...
								<select id="langFrom" name="lng-from" className="rq-input" className="classic" value={this.state.langFrom} onChange={this.handleChangeLangFrom}>
							...
							<div className="label-input-wrapper">
								...
								<select id="langTo" name="lng-to" className="rq-input" className="classic" value={this.state.langTo} onChange={this.handleChangeLangTo}>
